...
namespace dz_GuestBook.Controllers
{
    public class MessagesController : Controller
    {
        ...
        {
            return View(await _context.Messages.Include(u=>u.User).ToListAsync());
        }
        ...
        //public async Task<IActionResult> Create([Bind("Id,Message,MessageDate")] Messages messages)
        //{
        ...
        public async Task<IActionResult> Create( Messages messages)
        {
            if (ModelState.IsValid)
            {
                ...
                //mes.MessageDate = messages.MessageDate;
                ...
                messages.User = us.FirstOrDefault();
